...
export declare const maybeSuggestBindingsForLinearElementAtCoords: (
  linearElement: NonDeleted<ExcalidrawLinearElement>,
  pointerCoords: {
    x: number;
    y: number;
...
export declare const updateBindings: (
...
export declare const calculateFixedPointForElbowArrowBinding: (
...
export declare const bindingBorderTest: (
...
export declare const getGlobalFixedPointForBindableElement: (
  fixedPointRatio: [number, number],
  element: ExcalidrawBindableElement,
  elementsMap: ElementsMap
) => GlobalPoint;
export declare const getGlobalFixedPoints: (
  arrow: ExcalidrawElbowArrowElement,
  elementsMap: ElementsMap
) => [GlobalPoint, GlobalPoint];
export declare const getArrowLocalFixedPoints: (
  arrow: ExcalidrawElbowArrowElement,
  elementsMap: ElementsMap
) => LocalPoint[];
export declare const normalizeFixedPoint: <T extends FixedPoint | null>(
  fixedPoint: T
