import type { AppState, PendingExcalidrawElements } from "excalidraw-custom/types";
import {
  type ElementsMap,
...
export declare const getPredecessors: (
  node: ExcalidrawBindableElement,
  elementsMap: ElementsMap,
  direction: LinkDirection
) => ExcalidrawBindableElement[];
export declare const addNewNodes: (
...
export declare const isNodeInFlowchart: (
