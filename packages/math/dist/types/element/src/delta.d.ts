...
export declare class Delta<T> {
   ...
   */
  static diffObjects<T, K extends keyof T, V extends ValueOf<T[K]>>(
    deleted: Partial<T>,
    inserted: Partial<T>,
    property: K,
   ...
   */
  static diffArrays<T, K extends keyof T, V extends T[K]>(
    deleted: Partial<T>,
    inserted: Partial<T>,
    property: K,
   ...
   */
  static isLeftDifferent<T extends {}>(
    object1: T,
    object2: T,
    skipShallowCompare?: boolean
  ): boolean;
  /**
   * Compares if object2 contains any different value compared to the object1.
   */
  static isRightDifferent<T extends {}>(
    object1: T,
    object2: T,
    skipShallowCompare?: boolean
  ): boolean;
   ...
   */
  static isInnerDifferent<T extends {}>(
    object1: T,
    object2: T,
    skipShallowCompare?: boolean
  ): boolean;
   ...
   */
  static getLeftDifferences<T extends {}>(
    object1: T,
    object2: T,
    skipShallowCompare?: boolean
  ): string[];
   ...
   */
  static getRightDifferences<T extends {}>(
    object1: T,
    object2: T,
    skipShallowCompare?: boolean
  ): string[];
   ...
   */
  static getInnerDifferences<T extends {}>(
    object1: T,
    object2: T,
    skipShallowCompare?: boolean
  ): string[];
   ...
   */
  static getDifferences<T extends {}>(
    object1: T,
    object2: T,
    skipShallowCompare?: boolean
  ): string[];
...
type ElementPartial<TElement extends ExcalidrawElement = ExcalidrawElement> = Omit<
...
export declare class ElementsDelta implements DeltaContainer<SceneElementsMap> {
   ...
   */
  static calculate<T extends OrderedExcalidrawElement>(
