import type { AppClassProperties, DataURL, BinaryFiles } from "excalidraw-custom/types";
...
export declare const updateImageCache: ({
  fileIds,
  files,
  imageCache,
}: {
...
export declare const getInitializedImageElements: (
