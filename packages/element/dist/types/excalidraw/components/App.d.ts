...
export declare const useExcalidrawSetAppState: () => <K extends keyof AppState>(
  state:
    | AppState
    | ((prevState: Readonly<AppState>, props: Readonly<any>) => AppState | Pick<AppState, K> | null)
    | Pick<AppState, K>
    | null,
...
declare class App extends React.Component<AppProps, AppState> {
  ...
  getSceneElementsMapIncludingDeleted: () => Map<string, Ordered<ExcalidrawElement>> &
    import("@excalidraw/common/utility-types").MakeBrand<"SceneElementsMap">;
