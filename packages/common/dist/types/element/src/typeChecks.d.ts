...
export declare const isLineElement: (
  element?: ExcalidrawElement | null
) => element is ExcalidrawLineElement;
export declare const isArrowElement: (
  element?: ExcalidrawElement | null
) => element is ExcalidrawArrowElement;
export declare const isElbowArrow: (
  element?: ExcalidrawElement
) => element is ExcalidrawElbowArrowElement;
/**
 * sharp or curved arrow, but not elbow
 */
export declare const isSimpleArrow: (
  element?: ExcalidrawElement
) => element is ExcalidrawArrowElement;
export declare const isSharpArrow: (
  element?: ExcalidrawElement
) => element is ExcalidrawArrowElement;
export declare const isCurvedArrow: (
  element?: ExcalidrawElement
) => element is ExcalidrawArrowElement;
...
export declare const isRectanguloidElement: (
  element?: ExcalidrawElement | null
) => element is ExcalidrawBindableElement;
export declare const isRectangularElement: (
  element?: ExcalidrawElement | null
) => element is ExcalidrawBindableElement;
...
export declare const isFlowchartNodeElement: (
  element: ExcalidrawElement
...
export declare const getDefaultRoundnessTypeForElement: (element: ExcalidrawElement) =>
  ...
  | null;
export declare const isFixedPointBinding: (
  binding: PointBinding | FixedPointBinding
) => binding is FixedPointBinding;
export declare const isBounds: (box: unknown) => box is Bounds;
export declare const getLinearElementSubType: (
