...
import type { Device, InteractiveCanvasAppState, Zoom } from "excalidraw-custom/types";
...
export declare const getTransformHandlesFromCoords: (
...
export declare const getTransformHandles: (
...
export declare const shouldShowBoundingBox: (
