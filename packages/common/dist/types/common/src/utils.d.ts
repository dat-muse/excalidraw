...
export declare const isInputLike: (
...
export declare const isWritableElement: (
  target: Element | EventTarget | null
) => target is HTMLBRElement | HTMLDivElement | HTMLInputElement | HTMLTextAreaElement;
export declare const getFontFamilyString: ({
  fontFamily,
}: {
  fontFamily: FontFamilyValues;
}) => string;
/** returns fontSize+fontFamily string for assignment to DOM elements */
export declare const getFontString: ({
  fontSize,
  fontFamily,
}: {
  fontSize: number;
...
export declare const debounce: <T extends any[]>(
  fn: (...args: T) => void,
  timeout: number
) => {
  (...args: T): void;
...
export declare const throttleRAF: <T extends any[]>(
  fn: (...args: T) => void,
  opts?: {
    trailing?: boolean;
  }
 ...
 * cancelAnimation();
 */
export declare const easeToValuesRAF: <T extends Record<keyof T, number>, K extends keyof T>({
  fromValues,
  toValues,
  onStep,
  duration,
   ...
   */
  interpolateValue?:
    | ((fromValue: number, toValue: number, progress: number, key: K) => number | undefined)
    | undefined;
...
export declare const updateActiveTool: (
...
export declare const viewportCoordsToSceneCoords: (
  {
    clientX,
    clientY,
  }: {
...
export declare const sceneCoordsToViewportCoords: (
  {
    sceneX,
    sceneY,
  }: {
...
export declare const findLastIndex: <T>(
  array: readonly T[],
  cb: (element: T, index: number, array: readonly T[]) => boolean,
  fromIndex?: number
) => number;
/** returns the first non-null mapped value */
export declare const mapFind: <T, K>(
  collection: readonly T[],
  iteratee: (value: T, index: number) => K | null | undefined
) => K | undefined;
...
export declare const getNearestScrollableContainer: (
  element: HTMLElement
 ...
 */
export declare const arrayToMap: <
  T extends
    | string
    | {
        id: string;
...
>(
  items: Map<string, T> | readonly T[]
) => Map<string, T>;
export declare const arrayToMapWithIndex: <
  T extends {
    id: string;
  }
>(
 ...
 */
export declare const arrayToObject: <T>(
  array: readonly T[],
  groupBy?: ((value: T) => string | number) | undefined
) => {
  [key: string]: T;
};
/** Doubly linked node */
...
export declare const wrapEvent: <T extends Event>(
  name: EVENT,
  nativeEvent: T
) => CustomEvent<{
  nativeEvent: T;
}>;
export declare const updateObject: <T extends Record<string, any>>(
  obj: T,
  updates: Partial<T>
) => T;
 ...
 */
export declare const isShallowEqual: <T extends Record<string, any>, K extends readonly unknown[]>(
  objA: T,
  objB: T,
  comparators?:
    | { [key in keyof T]?: ((a: T[key], b: T[key]) => boolean) | undefined }
...
export declare const composeEventHandlers: <E>(
 ...
 */
export declare const assertNever: (
  value: never,
  message: string | null,
  softAssert?: boolean
) => never;
 ...
 */
export declare const memoize: <T extends Record<string, any>, R extends unknown>(
  func: (opts: T) => R
) => ((opts: T) => R) & {
  clear: () => void;
};
...
export declare const isMemberOf: <T extends string>(
  collection: Set<T> | Record<T, any> | Map<T, any> | readonly T[],
  value: string
) => value is T;
export declare const cloneJSON: <T>(obj: T) => T;
export declare const updateStable: <T extends any[] | Record<string, any>>(
  prevValue: T,
  nextValue: T
) => T;
export declare function addEventListener<K extends keyof WindowEventMap>(
...
export declare function addEventListener<K extends keyof DocumentEventMap>(
  target: Document,
  type: K,
...
export declare function addEventListener<K extends keyof FontFaceSetEventMap>(
  target: FontFaceSet,
  type: K,
  listener: (this: FontFaceSet, ev: FontFaceSetEventMap[K]) => any,
  options?: boolean | AddEventListenerOptions
): UnsubscribeCallback;
export declare function addEventListener<K extends keyof HTMLElementEventMap>(
 ...
 */
export declare const toBrandedType: <BrandedType, CurrentType = BrandedType>(
  value: Unbrand<BrandedType>
) => CurrentType & BrandedType;
export declare const promiseTry: <TValue, TArgs extends unknown[]>(
  fn: (...args: TArgs) => TValue | PromiseLike<TValue>,
  ...args: TArgs
) => Promise<TValue>;
...
export declare const reduceToCommonValue: <T, R = T>(
  collection: ReadonlySet<T> | readonly T[],
  getValue?: ((item: T) => R) | undefined
) => R | null;
export {};
